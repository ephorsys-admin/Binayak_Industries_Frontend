...
import heroBannerImg2 from '../../assets/explore_hero_poster.jpg';
import heroBannerImg3 from '../../assets/hero_banner.jpg';
...
const heroSlides = [
  {
    image: heroBannerImg,
    title: 'Discover the best artisanal snacks & sweets',
    subtitle:
      'Handcrafted Ratlami Sev, Bikaneri Bhujia, Desi Sweets & Roasted Nuts delivered fresh pan-India.',
  },
  {
    image: heroBannerImg2,
    title: 'Authentic Flavours Made Fresh Every Morning',
    subtitle:
      'Traditional Indian snacks and sweets crafted with premium ingredients and delivered fresh to your doorstep.',
  },
  {
    image: heroBannerImg3,
    title: 'Taste Tradition. Enjoy Every Bite.',
    subtitle:
      'From crunchy namkeens to delicious desi sweets, experience authentic flavours made with care.',
  },
];
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          ...
          toast.success(
            `📍 Live GPS Detected: ${detectedCity} (${detectedPincode})`,
            {
              id: toastId,
            }
          );
          ...
          toast.error(
            'Could not fetch address details. Please select your city.',
            {
              id: toastId,
            }
          );
      ...
      (error) => {
        ...
        toast.error(
          'Location access denied. Please choose your city manually.',
          {
            id: toastId,
          }
        );
  ...
  return (
    <div className="space-y-4 my-1">
      ...
      <div className="sm:hidden space-y-3 pt-0.5">
        ...
        <div className="bg-white rounded-3xl p-3.5 border border-stone-200/90 shadow-sm space-y-2.5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex items-center justify-center">
                <span className="w-2.5 h-2.5 rounded-full bg-[#004060] animate-ping absolute" />
                <span className="w-2.5 h-2.5 rounded-full bg-[#004060] relative" />
              </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#004060]/10 hover:bg-[#004060]/20 border border-[#004060]/40 text-[#004060] text-[10px] font-bold transition-all cursor-pointer"
            >
              {isDetectingGps ? (
                <Loader2 className="w-3 h-3 animate-spin" />
              ) : (
                <Navigation className="w-3 h-3 text-[#004060]" />
              )}

              <span>
                {isDetectingGps ? 'Locating...' : 'Live Location'}
              </span>
            </button>
          </div>
          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="w-7 h-7 rounded-xl bg-amber-500/10 flex items-center justify-center text-[#004060] shrink-0">
        ...
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#004060] via-[#006090] to-[#F5C542]/80 text-white p-5 shadow-lg border border-[#D79F26]/">

          <img
            src={currentHero.image}
            alt="50% OFF"
            className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-30 transition-opacity duration-700"
          />

          <div className="relative z-10 space-y-2">

            <h2 className="text-3xl font-black font-serif-heading tracking-tight leading-none text-white transition-all duration-500">
              50% OFF
            </h2>
      ...
      <div className="hidden sm:block relative w-full rounded-3xl overflow-hidden shadow-xl border border-stone-200/80">
        ...
        <div className="relative h-[380px] lg:h-[440px] w-full flex items-center justify-center">
          ...
          {/* Ambient Glows */}
          <div className="absolute -top-16 -left-16 w-64 h-64 bg-[#004060]/60 rounded-full blur-3xl pointer-events-none" />

          <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-[#D79F26]/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-5">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/15 backdrop-blur-md border border-white/25 text-[#ffd25d] text-xs font-bold uppercase tracking-wider shadow-sm animate-pulse">
              ...
              <span>
                100% Single-Press Groundnut Oil • Fresh Morning Batches
              </span>
            </div>

            {/* Main Hero Heading - SLIDER TEXT */}
            <h1
              key={`title-${currentSlide}`}
              className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight font-serif-heading drop-shadow-md leading-tight animate-in fade-in slide-in-from-right-4 duration-700"
            >
              {currentHero.title}
            </h1>

            {/* Subtitle - SLIDER TEXT */}
            <p
              key={`subtitle-${currentSlide}`}
              className="text-sm sm:text-base text-stone-200 max-w-xl mx-auto font-medium animate-in fade-in slide-in-from-right-4 duration-700"
            >
              {currentHero.subtitle}
            </p>
                ...
                <div className="absolute left-0 right-0 bottom-full mb-3 bg-white rounded-3xl shadow-2xl border border-stone-200 p-4 z-50 animate-in fade-in zoom-in-95 duration-150 text-left">
                  ...
                  <div className="flex items-center justify-between pb-2.5 border-b border-stone-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      <Building2 className="w-4 h-4 text-[#F5C558]" />
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-[#004060] bg-[#004060]/10 px-2 py-0.5 rounded-full border border-emerald-100">
                        ⚡ Pan-India Shipping
                      </span>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 mt-3">
                    ...
                    {popularDeliveryHubs.map((hub, idx) => {
                      const isSelected =
                        selectedLocation.pincode === hub.pincode;
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            ...
                            toast.success(
                              `📍 Delivery address set to ${hub.city}!`
                            );
                          }}
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between gap-1">
                            ...
                            {isSelected && (
                              <Check className="w-3.5 h-3.5 text-[#981b2e] shrink-0" />
                            )}
                          ...
                          <div className="flex items-center justify-between mt-1 text-[10px] text-stone-400">
                            ...
                            <span className="px-1.5 py-0.2 rounded bg-[#D79F26]/5 text-[#003060] font-bold border border-[#D79F26]/40">
                              {hub.tag}
                            </span>
                  ...
                  <form
                    ...
                    className="mt-3 pt-3 border-t border-stone-100 flex items-center gap-2"
                  >
                    ...
                    <input
                      ...
                      className="flex-1 text-xs px-3.5 py-2 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D79F26] font-medium"
                    />
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-full p-2.5 shadow-2xl border border-white/80 flex items-center justify-between gap-3 text-left">
                ...
                <div className="relative flex-1 flex items-center gap-2.5 pl-3 min-w-0">
                  ...
                  <div className="relative flex items-center justify-center shrink-0">
                    ...
                    <span className="w-3 h-3 rounded-full bg-[#004060] animate-ping absolute opacity-75" />
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-xs lg:text-sm font-extrabold text-stone-900 hover:text-[#D79F26] transition-colors cursor-pointer max-w-full text-left truncate"
                    >
                ...
                <button
                  ...
                  onClick={handleDetectGpsLocation}
                  disabled={isDetectingGps}
                  className="px-3.5 py-2 rounded-full bg-[#0080B0]/8 hover:bg-[#0080B0]/20 border border-[#004060]/20 text-[#004060] text-xs font-bold transition-all flex items-center gap-1.5 shrink-0 cursor-pointer shadow-2xs hover:scale-102 active:scale-95"
                ...
                >
                  ...
                  {isDetectingGps ? (
                    ...
                    <Navigation className="w-3.5 h-3.5 text-[#004060] fill-emerald-600/20" />
                  )}
                ...
                <Link
                  to="/explore"
                  className="px-5 lg:px-6 py-2.5 lg:py-3 rounded-full bg-[#004060] hover:bg-[#006090] active:scale-95 text-white text-xs lg:text-sm font-black shadow-md shadow-rose-950/30 transition-all shrink-0 cursor-pointer flex items-center gap-1.5"
                >
            ...
            <div className="flex items-center justify-center gap-4 text-[11px] font-semibold text-stone-300 pt-1">
              ...
              <span className="flex items-center gap-1">
                <ShieldCheck className="w-3.5 h-3.5 text-[#006090]" />
