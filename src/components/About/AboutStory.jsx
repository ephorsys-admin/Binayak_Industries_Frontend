...
const milestones = [
  ...
  {
    value: "100%",
    label: "Cold-Pressed Groundnut Oil",
    icon: ShieldCheck,
  },
  {
    value: "50k+",
  ...
  {
    value: "25+",
    label: "Authentic Snack Varieties",
    icon: Heart,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="hidden sm:flex absolute -bottom-4 -right-4 bg-[#0a2540] text-white p-3.5 rounded-2xl border border-stone-700 shadow-lg items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-stone-300">
                Zero Palm Oil or Preservatives
              </p>
            </div>
        ...
        >
          ...
          <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
            ...
            , we believe every snack is an emotion. What started three
            decades ago as a humble family kitchen dedicated to authentic
            Rajasthani and Malwi namkeens has blossomed into a beloved
            artisanal food house trusted across India.
          </p>

          {/* Paragraph 2 */}
          <p className="text-stone-600 text-xs sm:text-sm leading-relaxed">
            From our iconic fiery Ratlami Sev prepared with hand-ground
            clove and black pepper, to sweet & tangy Khatta Meetha Chivda,
            crunchy Murukku, and pure Gir cow ghee festive sweets — every
            delicacy is fried exclusively in pure cold-pressed groundnut oil
            in daily fresh small batches.
          </p>
            ...
            {milestones.map((m, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-3 rounded-2xl bg-stone-50 border border-stone-200/60 space-y-1"
                >
                  ...
                  <div className="flex items-center gap-1 text-[#981b2e]">
                    ...
                    <span className="text-lg sm:text-xl font-black font-brand text-stone-900">
                      {m.value}
                    </span>
