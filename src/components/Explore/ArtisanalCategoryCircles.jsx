...
import { categoriesList } from './snacksData';
        ...
        {categoriesList.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Modern Circle Icon Container */}
              <div
                className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full ${item.bg} ${item.border} border flex items-center justify-center mb-2.5 shadow-2xs group-hover:scale-108 transition-all duration-300 ${
              ...
              {/* Title & Count */}
              <div>
                <span className={`block text-xs sm:text-sm font-bold leading-tight transition-colors ${
